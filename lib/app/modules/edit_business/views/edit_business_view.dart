...
import 'package:business_dir/app/modules/edit_business/views/category_selection/views/category_selection_view.dart';
import 'package:business_dir/app/modules/edit_business/views/pick_business_location_view.dart';

import 'package:business_dir/app/modules/edit_business/views/widgets/r_city_drop_down.dart';
import 'package:business_dir/app/modules/edit_business/views/widgets/r_select_image_container.dart';
import 'package:business_dir/app/modules/edit_business/views/widgets/r_text_field_list.dart';
...
class EditBusinessView extends GetView<EditBusinessController> {
  EditBusinessView({super.key});

  final imagePickController = Get.find<ImagePickerController>();
  final business = Get.find<MyBusinessesController>().selectedBusiness.value;
  @override
            ...
            children: [
              Stack(
                children: [
                  ...
                  Obx(
                    () => imagePickController.businessLogoPath.value != null
                        ? Positioned(
                            bottom: 4,
                            left: 0,
                            child: RCircledButton(
                              onTap: () {
                                imagePickController.businessLogoPath.value =
                                    null;
                              },
                              icon: Icons.close,
                            ),
              ...
              RSelectImageContainer(
                onTap: () async {
                  ...
                  imagePickController.businessImagesPath.refresh();
                },
              ),
              SizedBox(height: Get.height * 0.01),
              Obx(
